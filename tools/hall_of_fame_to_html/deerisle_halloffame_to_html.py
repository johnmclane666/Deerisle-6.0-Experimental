...
def generate_html(json_paths, output_file):
    ...
    # HTML Aufbau (inklusive CSS für Styling)
    html = f"""<!DOCTYPE html>
<html lang="de">
<head>
    <meta charset="UTF-8">
        ...
        for i, s in enumerate(survivors):
            ...
            html += f"""
                    <tr>
                        ...
                        <td class="hide-mobile mono-text" style="color: var(--text-muted); font-size: 0.9rem;">
                            {s.get('EndgameID', 'N/A')}
                        </td>
                    </tr>"""
...
"""
    ...
    print(f"Erfolg! Webseite wurde in '{output_file}' erstellt.")
